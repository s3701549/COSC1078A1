...
<h3>Tools and Technologies</h3>
 ...
 <h3>Outcome </h3>
 <p>If the project is successful, more school can enjoy the convenience of this app,even the primary school and high school. Students don’t need to go to school for enroll and waiting the notification about their class assignment. it makes school management more intelligent. The App provide an online communication platform for teachers, students and their parents, it’s effectively solved the teacher and student communication difficult, dare not communicate and so on the question. this app will be a new step for school construction, but this app still will bring some problems such as Young students not enough self-control and use mobile phones too much, that will hurt them academically and physically. So parents and teachers should increase the intensity and supervision to prevent such incidents from happening.</p>
